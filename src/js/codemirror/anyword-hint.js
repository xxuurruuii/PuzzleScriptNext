...
(function(mod) {
    if (typeof exports == "object" && typeof module == "object") // CommonJS
        ...
        var PRELUDE_COMMAND_WORDS = [
            ...
            ["render_height", "", "Enable 3D renderer for gameplay screens."],
            ["default_height", "0.2", "Default object height factor used by 3D rendering when render_height is enabled."],
            ...
            ["hide_labeled_levels", "", "Hides map levels preceded by HIDDEN lines from auto-next progression and completion counts"],
        ...
        var RULE_COMMAND_WORDS = [
            "COMMAND",
            "sfx0", "sfx1", "sfx2", "sfx3", "sfx4", "sfx5", "sfx6", "sfx7", "sfx8", "sfx9", "sfx10", "cancel", "checkpoint", "restart", "win", "message", "again", "nosave", "quit", "border", "savestate", "loadstate",
